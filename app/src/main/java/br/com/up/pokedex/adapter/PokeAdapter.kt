...
class PokeAdapter(private val pokemons:List<Pokemon>, private val listener:(pokemon:Pokemon) -> Unit ) : RecyclerView.Adapter<PokeAdapter.PokeViewHolder>() {
    ...
    override fun onBindViewHolder(holder: PokeViewHolder, position: Int) {
        ...
        val data : TextView = holder.itemView.findViewById(R.id.textView1)
        data.text =
            pokemon.name.replaceFirstChar { if (it.isLowerCase()) it.titlecase(Locale.getDefault()) else it.toString() }//First character Uppercase
